...
namespace Microsoft.CST.OpenSource.FindSquats
{
    ...
    public class FindSquatsTool : OSSGadget
    {
        ...
        public async Task<(string output, int numSquats)> RunAsync(Options options)
        {
            ...
            using(var reader = new StreamReader(@"/Users/kids/Documents/typosquat-project/pypi_popular.csv"))
            {
                // skip headers
                reader.ReadLine();
            ...
            using(var reader = new StreamReader(@"/Users/kids/Documents/typosquat-project/pypi_unpopular.csv"))
            {
                // skip headers
                reader.ReadLine();
